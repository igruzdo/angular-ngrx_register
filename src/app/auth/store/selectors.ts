...
export const isLoggedInSelector = createSelector(authFeatureSevector, (authState: AuthStateInterface) => 
    authState.isLoggedIn
);

export const isAnonimusSelector = createSelector(authFeatureSevector, (authState: AuthStateInterface) => 
    authState.isLoggedIn === false
);

export const currentUserSelector = createSelector(authFeatureSevector, (authState: AuthStateInterface) => 
